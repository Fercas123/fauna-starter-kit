    ...
    return (
        <SWRConfig value={{fallback}}>
            ...
            <header
                ...
                <nav>
                    <a className="text-xs px-[1rem] hover:text-green-700" href="#eventos">Eventos</a>
                    <a className="text-xs px-[1rem] hover:text-green-700" href="#regalos">Mesa de regalos</a>
                    <a className="text-xs px-[1rem] hover:text-green-700" href="#rsvp">RSVP</a>
                </nav>
            </header>
            <main className="max-w-4xl mx-auto p-4 m-0 font-sans text-sm">
                <section className="py-[1.2rem] text-center grid justify-center">
                    ...
                    <p>Asi que por favor confirma lo que ya sabemos: ¡vienes seguro!</p>
                    <p>La ceremonia tendrá lugar el</p>
                    <h2 className="text-lg font-bold">Sabado 15 de Abril 2023 en Oaxaca, Mexico</h2>
                </section>
                <hr className="mx-auto my-[1rem] w-28 transition transition-[width] ease-linear duration-1000	"/>
                <section className="py-[1.2rem] text-center flex flex-wrap justify-center gap-[3rem]" id="eventos">
                ...
                <hr className="mx-auto my-[1rem] w-28 transition transition-[width] ease-linear duration-1000	"/>
                <section className="py-[1.2rem] text-center" id="regalos">
